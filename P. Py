...
# ===================================================================
# CONFIGURATION – v3.3 PROFESSIONAL
# ===================================================================
...
class TradingOrchestrator:
    ...
    def run_analysis(self) -> Optional[Dict]:
        ...
        try:
            ...
            if status == 'success':
                ...
                # Also calculate next weekly if needed
    ...
    def execute_best_mandate(self, analysis: Dict) -> Optional[str]:
        ...
        # Smart selection: Use next weekly if current weekly is expiry day and next weekly is better
        ...
        if weekly_mandate.dte <= 1 and analysis.get('next_weekly_mandate'):
            ...
            if next_mandate.score.composite > weekly_mandate.score.composite:
                logger.info(f"Switching to NEXT WEEKLY (Expiry day avoidance): {next_mandate.score.composite:.2f} vs {weekly_mandate.score.composite:.2f}")
...
def main():
    ...
    db_writer.set_state("system_version", "3.3-PROFESSIONAL")
